...
exports.getQuizName = (req, res) => {
  db.sequelize
    .query("select * from quiz where quizName=?", {
      replacements: [req.body.quizName],
...
exports.insert = (req, res) => {
  ...
  db.sequelize
    .query(
      "insert into quiz(quizName,categoryId,duration,count) values (?,?,?,?)",
      {
        replacements: [
          req.body.quizName,
          req.body.categoryId,
...
exports.getQuizNameById = (req, res) => {
  db.sequelize
    .query("select * from quiz where categoryId=?", {
...
exports.getQuizName = (req, res) => {
  db.sequelize
    .query("select * from quiz ", { type: db.sequelize.QueryTypes.SELECT })
    .then((data) => {
      res.send(data);
      console.log(data);
    });
